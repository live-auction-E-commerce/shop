        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/live-auctions" className="text-gray-600 hover:text-rose-500">
                  Live Auctions
                </a>
              </li>
              <li>
                <a href="/buy-now" className="text-gray-600 hover:text-rose-500">
                  Buy Now
                </a>
              </li>
              <li>
                <a href="/how-it-works" className="text-gray-600 hover:text-rose-500">
                  How It Works
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/categories/shirts" className="text-gray-600 hover:text-rose-500">
                  Shirts
                </a>
              </li>
              <li>
                <a href="/categories/jeans" className="text-gray-600 hover:text-rose-500">
                  Jeans
                </a>
              </li>
              <li>
                <a href="/categories/shoes" className="text-gray-600 hover:text-rose-500">
                  Shoes
                </a>
              </li>
              <li>
                <a href="/categories/bags" className="text-gray-600 hover:text-rose-500">
                  Bags
                </a>
              </li>
            </ul>
